...
execute_process(
  COMMAND "/usr/bin/git" show-ref "v2.0.10"
  WORKING_DIRECTORY "/Users/heidrunheidarsdottir/group-5-libSMCE/build/_deps/mosquitto-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/heidrunheidarsdottir/group-5-libSMCE/build/_deps/mosquitto-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/heidrunheidarsdottir/group-5-libSMCE/build/_deps/mosquitto-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
